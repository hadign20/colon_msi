...
excel_file_names = ["TumorTexture", "TumorTexturePreprocessing", "TumorBoundaryTexture", "TumorBoundaryTexturePreprocessing"]
SELECTED_SHEET = "all" # "all",  "3_1"
...
FEATURE_SELECTION_METHOD = 'auc' # 'mrmr', 'pvalue', 'auc', 'composite'
min_num_features = 1
max_num_features = 20
...
def main():
    for excel_file_name in excel_file_names:
        ...
        selected_sheets = []
        if SELECTED_SHEET == "all": selected_sheets = xls.sheet_names
        else: selected_sheets.append(SELECTED_SHEET)
